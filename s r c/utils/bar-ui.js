        ...
        onerror: function() {
          ...
          if (item) {
            ...
            if (extras.loadFailedCharacter) {
              dom.playlistTarget.innerHTML = dom.playlistTarget.innerHTML.replace(
                "<li>",
              ...
              if (
                ...
                element = playlistController.data.playlist[
                  playlistController.data.selectedIndex
    ...
    actions = {
      ...
      shuffle: function(e) {
        ...
        if (target && !utils.css.has(target, css.disabled)) {
          ...
          playlistController.data.shuffleMode = !playlistController.data
            .shuffleMode;
        }
      },
