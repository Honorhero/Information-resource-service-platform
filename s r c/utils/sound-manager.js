...
//         colorString =
//           "rgba(" +
//           hexToRGB(colorValue.substr(1))
//             .concat([opacityValue / 100])
//             .join(", ") +
//           ")";
//       } else {
...
//       } else if (opacityValue < 100) {
//         demoData.colorOutput.innerHTML =
//           "background-color: " +
//           colorValue +
//           "; /* non-RGBA fallback */\n background-color: " +
//           colorString +
...
//         document.getElementById("texture-output").innerHTML =
...
//         document.getElementById("fontsize-output").innerHTML =
//           currentValue + "px;";
//       }
//     }
...
//       var colorTimer, changeHandler;

//       // this is dumb: resort to polling until change event fires.

//       changeHandler = utils.events.add(demoData.colorPicker, "change", function(
//         e
//       ) {
...
//       var i,
//         j,
//         nodes = utils.dom.getAll(selector || playerSelector);
...
//       className = className.replace(/[ ]playing|[ ]paused|[ ]buffering/gi, "");

//       document.getElementById("player-code-example").innerHTML = className;
//     }

//     utils.events.add(document.getElementById("fullwidth"), "click", function(
//       e
//     ) {
